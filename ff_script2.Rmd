...
agebcm1<-summary (coxph(Surv(ff_doses$survival_mo,ff_doses$dead01) ~ age_dx + smi_pre+ smd_pre + smcd_pre + smcg_pre + smcg2_pre + sex   + m1_bone + m1_liver + m1_lung + m1_n3 + m1_peritoneum +  m1_other , data=ff_doses ))
...
## Distribution of days of FOLFOX treatment

```{r}

hist(ff_doses$folfox_full_days,breaks=50, xlab= "Days of FOLFOX Therapy", main="Distribution of days of FOLFOX treatment")
...
legend(40,1.05,lwd=3,legend=c(paste("Lung M0 n=",lungm0, "\nmedian=",median_lungm0,"mo\n"),paste("Lung M1 n=",lungm0,"\nmedian=",median_lungm1,"mo")), lty=1, bty="n",title="Lung Metastatic Disease",col=c("blue","red"))
text(10,0.15,paste0('log rank p=', log_rank_p_lungm1))
